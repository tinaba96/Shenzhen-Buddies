...
export const zhHans: Dictionary = {
  ...
  seo: {
    ...
    toursTitle: '深圳免费本地体验 — Shenzhen Buddies',
    toursDescription:
      '六个一对一的深圳体验，试运营期间免费——华强北电子市场、东门小吃、入夜后的天际线，以及从香港过关后的头几个小时。',
  },
  ...
  home: {
    hero: {
      ...
      titleLead: '和一个懂你的人',
      titleAccent: '一起看深圳。',
      body: '别再挤旅游大巴。和一位兴趣相投的本地人免费待上几个小时——电子、美食、天际线、清晨——这座城市终于说得通了。',
      primaryCta: '查看免费体验',
      secondaryCta: '成为向导',
      scroll: '向下',
    },
    ...
    packages: {
      kicker: '几个小时，一位本地人',
      title: '挑一个三小时。',
      body: '下面每个体验都是一对一，试运营期间免费——两小时或三小时，只把一件事做透，而不是隔着车窗瞄六个地方。',
      featuredLabel: '预订最多',
      allLink: '全部体验',
      priceNote: '试运营期间{price}——伙伴的时间不收钱，你吃的、坐的都按本地价自己付。',
    },
    districts: {
      kicker: '地图',
      title: '六个区，六座不同的城。',
    ...
    promise: {
      ...
      items: [
        ...
        {
          title: '真的免费',
          body: '试运营期间预订不花一分钱——不用卡，也不用订金。如果我们没能确认你的日子，会马上告诉你，本来就没扣过款。',
        },
      ],
    },
    howItWorks: {
      ...
      steps: [
        ...
        {
          title: '挑一天',
          body: '可约日期实时显示。免费预约两小时或三小时，我们会在三个工作日内确认。',
        },
        {
          title: '碰面，出发',
    ...
    finalCta: {
      ...
      bodySingleGuide: '选个日子，免费预订和本地人的几个小时。',
  ...
  tours: {
    index: {
      kicker: '体验',
      title: '几个小时，认认真真过完。',
      body: '六个一对一体验，试运营期间免费——每次两小时或三小时。你订的是一位深圳本地人的下午，不是大巴上的一个座位——所以当天路线会跟着你走。',
      priceLine: '一对一，两到三小时，{price}',
      countLine: '{n} 个体验',
      notATour: {
        title: '我们不是旅行社。',
        body: '没有大巴、没有团、没有小旗子，也没有回扣。你订的是一位深圳本地人的几个小时——试运营期间免费；那天你吃的、坐的、买的，都按本地价直接付给店家。',
      },
    },
    detail: {
      itinerary: '这一天怎么走',
      ...
      readMore: '读完整指南',
      otherExperiences: '其他体验',
      bookCta: '预订这一天——免费',
      bookNote: '下一步选日期、时长（两小时或三小时）和出发时间。全程不用付款。',
      backToAll: '全部体验',
    },
  },
  ...
  guide: {
    selectedPackage: {
      label: '已选体验',
      note: '我们已经写进你的预订备注里，伙伴会看到。提交前可以在下面修改或清除。',
      clear: '清除选择',
      change: '换一个体验',
    },
  },
