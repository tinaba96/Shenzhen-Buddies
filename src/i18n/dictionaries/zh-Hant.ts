...
export const zhHant: Dictionary = {
  ...
  seo: {
    ...
    toursTitle: '深圳免費本地體驗 — Shenzhen Buddies',
    toursDescription:
      '六個一對一的深圳體驗，試營運期間免費——華強北電子市場、東門小食、入黑後的天際線，以及由香港過關後的頭幾個小時。',
  },
  ...
  home: {
    hero: {
      ...
      titleLead: '和一個懂你的人',
      titleAccent: '一起看深圳。',
      body: '不必再擠旅遊巴。和一位興趣相投的本地人免費過幾個小時——電子、美食、天際線、清晨——這座城市終於說得通了。',
      primaryCta: '查看免費體驗',
      secondaryCta: '成為嚮導',
      scroll: '向下',
    },
    ...
    packages: {
      kicker: '幾個小時，一位本地人',
      title: '挑一個三小時。',
      body: '下面每個體驗都是一對一，試營運期間免費——兩小時或三小時，只把一件事做透，而不是隔著車窗看六個景點。',
      featuredLabel: '最多人預訂',
      allLink: '全部體驗',
      priceNote: '試營運期間{price}——夥伴的時間不收錢，你吃的、搭的都按本地價自己付。',
    },
    districts: {
      kicker: '地圖',
      title: '六個區，六座不同的城。',
    ...
    promise: {
      ...
      items: [
        ...
        {
          title: '真的免費',
          body: '試營運期間預訂不花一分錢——不用卡，也不用訂金。如果我們無法確認你的日子，會馬上告訴你，本來就沒收過款。',
        },
      ],
    },
    howItWorks: {
      ...
      steps: [
        ...
        {
          title: '挑一天',
          body: '可預約日期即時顯示。免費預約兩小時或三小時，我們會在三個工作天內確認。',
        },
        {
          title: '見面，出發',
    ...
    finalCta: {
      ...
      bodySingleGuide: '選個日子，免費預訂和本地人的幾個小時。',
  ...
  tours: {
    index: {
      kicker: '體驗',
      title: '幾個小時，認真走完。',
      body: '六個一對一體驗，試營運期間免費——每次兩小時或三小時。你訂的是一位深圳本地人的下午，不是旅遊巴上的一個座位——所以當天路線會跟著你走。',
      priceLine: '一對一，兩至三小時，{price}',
      countLine: '{n} 個體驗',
      notATour: {
        title: '我們不是旅行社。',
        body: '沒有旅遊巴、沒有團、沒有小旗，也沒有佣金。你訂的是一位深圳本地人的幾個小時——試營運期間免費；那天你吃的、搭的、買的，全部按本地價直接付給店家。',
      },
    },
    detail: {
      itinerary: '這一天怎麼走',
      ...
      tourLength: '行程時長',
      customizable: '行程可以按每位旅客的需要調整——預訂時隨時告訴我們你的想法。',
      includes: '包含什麼',
      notIncluded: '不包含什麼',
      goodFor: '適合誰',
      insiderTip: '有件事值得先知道',
      ...
      price: '價錢',
      priceNote: '試營運期間免費——預訂時不付一分錢。當天你吃的、搭的、買的按本地價自己付。',
      readMore: '讀完整指南',
      otherExperiences: '其他體驗',
      bookCta: '預訂這一天——免費',
      bookNote: '下一步選日期、時長（兩小時或三小時）和出發時間。全程不用付款。',
      backToAll: '全部體驗',
    },
  },
  ...
  guide: {
    selectedPackage: {
      label: '已選體驗',
      note: '我們已經寫進你的預訂備註，夥伴會看到。送出前可以在下面修改或清除。',
      clear: '清除選擇',
      change: '換另一個體驗',
    },
  },
